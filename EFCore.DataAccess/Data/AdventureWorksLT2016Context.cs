    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BuildVersion>(entity =>
        {
            ...
            entity.Property(e => e.ModifiedDate)
                .HasDefaultValueSql("(getdate())")
                .HasComment("Date and time the record was last updated.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_BuildVersion_ModifiedDate")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.Property(e => e.NameStyle)
                ...
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Customer_NameStyle");
            ...
            entity.Property(e => e.Rowguid)
                .HasDefaultValueSql("(newid())")
                .HasComment("ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Customer_rowguid")
                .HasColumnName("rowguid");
        ...
        modelBuilder.Entity<CustomerAddress>(entity =>
        {
            ...
            entity.Property(e => e.ModifiedDate)
                .HasDefaultValueSql("(getdate())")
                .HasComment("Date and time the record was last updated.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_CustomerAddress_ModifiedDate")
                .HasColumnType("datetime");
            entity.Property(e => e.Rowguid)
                .HasDefaultValueSql("(newid())")
                .HasComment("ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_CustomerAddress_rowguid")
                .HasColumnName("rowguid");
        ...
        modelBuilder.Entity<ErrorLog>(entity =>
        {
            ...
            entity.Property(e => e.ErrorTime)
                ...
                .HasAnnotation("Relational:DefaultConstraintName", "DF_ErrorLog_ErrorTime")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.Property(e => e.Rowguid)
                .HasDefaultValueSql("(newid())")
                .HasComment("ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Product_rowguid")
                .HasColumnName("rowguid");
        ...
        modelBuilder.Entity<ProductCategory>(entity =>
        {
            ...
            entity.Property(e => e.ModifiedDate)
                .HasDefaultValueSql("(getdate())")
                .HasComment("Date and time the record was last updated.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_ProductCategory_ModifiedDate")
                .HasColumnType("datetime");
            entity.Property(e => e.Name)
                .IsRequired()
                .HasMaxLength(50)
            ...
            entity.Property(e => e.Rowguid)
                .HasDefaultValueSql("(newid())")
                .HasComment("ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_ProductCategory_rowguid")
                .HasColumnName("rowguid");
        ...
        modelBuilder.Entity<ProductDescription>(entity =>
        {
            ...
            entity.Property(e => e.ModifiedDate)
                .HasDefaultValueSql("(getdate())")
                .HasComment("Date and time the record was last updated.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_ProductDescription_ModifiedDate")
                .HasColumnType("datetime");
            entity.Property(e => e.Rowguid)
                .HasDefaultValueSql("(newid())")
                .HasComment("ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample.")
        ...
        modelBuilder.Entity<ProductModel>(entity =>
        {
            ...
            entity.Property(e => e.ModifiedDate)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_ProductModel_ModifiedDate")
                .HasColumnType("datetime");
            entity.Property(e => e.Name)
                .IsRequired()
                .HasMaxLength(50);
            entity.Property(e => e.Rowguid)
                .HasDefaultValueSql("(newid())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_ProductModel_rowguid")
                .HasColumnName("rowguid");
        });
        ...
        modelBuilder.Entity<ProductModelProductDescription>(entity =>
        {
            ...
            entity.Property(e => e.ModifiedDate)
                .HasDefaultValueSql("(getdate())")
                .HasComment("Date and time the record was last updated.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_ProductModelProductDescription_ModifiedDate")
                .HasColumnType("datetime");
            entity.Property(e => e.Rowguid)
                .HasDefaultValueSql("(newid())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_ProductModelProductDescription_rowguid")
                .HasColumnName("rowguid");
        ...
        modelBuilder.Entity<SalesOrderDetail>(entity =>
        {
            ...
            entity.Property(e => e.ModifiedDate)
                .HasDefaultValueSql("(getdate())")
                .HasComment("Date and time the record was last updated.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderDetail_ModifiedDate")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.Rowguid)
                .HasDefaultValueSql("(newid())")
                .HasComment("ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderDetail_rowguid")
                .HasColumnName("rowguid");
            ...
            entity.Property(e => e.UnitPriceDiscount)
                ...
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderDetail_UnitPriceDiscount")
                .HasColumnType("money");
        ...
        modelBuilder.Entity<SalesOrderHeader>(entity =>
        {
            ...
            entity.Property(e => e.Freight)
                ...
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderHeader_Freight")
                .HasColumnType("money");
            entity.Property(e => e.ModifiedDate)
                .HasDefaultValueSql("(getdate())")
                .HasComment("Date and time the record was last updated.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderHeader_ModifiedDate")
                .HasColumnType("datetime");
            entity.Property(e => e.OnlineOrderFlag)
                .HasDefaultValue(true)
                .HasComment("0 = Order placed by sales person. 1 = Order placed online by customer.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderHeader_OnlineOrderFlag");
            entity.Property(e => e.OrderDate)
                .HasDefaultValueSql("(getdate())")
                .HasComment("Dates the sales order was created.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderHeader_OrderDate")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.RevisionNumber)
                ...
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderHeader_RevisionNumber");
            entity.Property(e => e.Rowguid)
                .HasDefaultValueSql("(newid())")
                .HasComment("ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderHeader_rowguid")
                .HasColumnName("rowguid");
            ...
            entity.Property(e => e.Status)
                ...
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderHeader_Status");
            entity.Property(e => e.SubTotal)
                .HasComment("Sales subtotal. Computed as SUM(SalesOrderDetail.LineTotal)for the appropriate SalesOrderID.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderHeader_SubTotal")
                .HasColumnType("money");
            entity.Property(e => e.TaxAmt)
                .HasComment("Tax amount.")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_SalesOrderHeader_TaxAmt")
                .HasColumnType("money");
